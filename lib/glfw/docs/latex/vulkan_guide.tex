...
For details on a specific Vulkan support function, see the vulkan. There are also guides for the other areas of the GLFW API.
...
By default, GLFW will load the Vulkan loader dynamically at runtime via its standard name\+: {\ttfamily vulkan-\/1.\+dll} on Windows, {\ttfamily libvulkan.\+so.\+1} on Linux and other Unix-\/like systems and {\ttfamily libvulkan.\+1.\+dylib} on mac\+OS.

{\bfseries{mac\+OS\+:}} GLFW will also look up and search the {\ttfamily Frameworks} subdirectory of your application bundle.

If your code is using a Vulkan loader with a different name or in a non-\/standard location you will need to direct GLFW to it. Pass your version of {\ttfamily vk\+Get\+Instance\+Proc\+Addr} to glfw\+Init\+Vulkan\+Loader before initializing GLFW and it will use that function for all Vulkan entry point retrieval. This prevents GLFW from dynamically loading the Vulkan loader.


\begin{DoxyCode}{0}
\DoxyCodeLine{glfwInitVulkanLoader(vkGetInstanceProcAddr);}

\end{DoxyCode}


{\bfseries{mac\+OS\+:}} To make your application be redistributable you will need to set up the application bundle according to the LunarG SDK documentation. This is explained in more detail in the \href{https://vulkan.lunarg.com/doc/sdk/latest/mac/getting_started.html}{\texttt{ SDK documentation for mac\+OS}}.\hypertarget{vulkan_guide_vulkan_include}{}\doxysection{Including the Vulkan header file}\label{vulkan_guide_vulkan_include}
To have GLFW include the Vulkan header, define \mbox{\hyperlink{build_guide_GLFW_INCLUDE_VULKAN}{GLFW\+\_\+\+INCLUDE\+\_\+\+VULKAN}} before including the GLFW header.
...
If you are loading the Vulkan loader dynamically instead of linking directly against it, you can check for the availability of a loader and ICD with glfw\+Vulkan\+Supported.


\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordflow}{if} (glfwVulkanSupported())}
\DoxyCodeLine{\{}
...
If one or both were not found, calling any other Vulkan related GLFW function will generate a GLFW\+\_\+\+API\+\_\+\+UNAVAILABLE error.\hypertarget{vulkan_guide_vulkan_proc}{}\doxysubsection{Querying Vulkan function pointers}\label{vulkan_guide_vulkan_proc}
...
Device-\/specific functions may execute a little faster, due to not having to dispatch internally based on the device passed to them. For more information about {\ttfamily vk\+Get\+Device\+Proc\+Addr}, see the Vulkan documentation.\hypertarget{vulkan_guide_vulkan_ext}{}\doxysection{Querying required Vulkan extensions}\label{vulkan_guide_vulkan_ext}
...
To query the instance extensions required, call glfw\+Get\+Required\+Instance\+Extensions.


\begin{DoxyCode}{0}
\DoxyCodeLine{uint32\_t count;}
\DoxyCodeLine{\textcolor{keyword}{const} \textcolor{keywordtype}{char}** extensions = glfwGetRequiredInstanceExtensions(\&count);}
...
If successful the returned array will always include {\ttfamily VK\+\_\+\+KHR\+\_\+surface}, so if you don\textquotesingle{}t require any additional extensions you can pass this list directly to the {\ttfamily Vk\+Instance\+Create\+Info} struct.


\begin{DoxyCode}{0}
\DoxyCodeLine{VkInstanceCreateInfo ici;}
\DoxyCodeLine{}
...
Additional extensions may be required by future versions of GLFW. You should check whether any extensions you wish to enable are already in the returned array, as it is an error to specify an extension more than once in the {\ttfamily Vk\+Instance\+Create\+Info} struct.

{\bfseries{mac\+OS\+:}} Molten\+VK is (as of July 2022) not yet a fully conformant implementation of Vulkan. As of Vulkan SDK 1.\+3.\+216.\+0, this means you must also enable the {\ttfamily VK\+\_\+\+KHR\+\_\+portability\+\_\+enumeration} instance extension and set the {\ttfamily VK\+\_\+\+INSTANCE\+\_\+\+CREATE\+\_\+\+ENUMERATE\+\_\+\+PORTABILITY\+\_\+\+BIT\+\_\+\+KHR} bit in the instance creation info flags for Molten\+VK to show up in the list of physical devices. For more information, see the Vulkan and Molten\+VK documentation.\hypertarget{vulkan_guide_vulkan_present}{}\doxysection{Querying for Vulkan presentation support}\label{vulkan_guide_vulkan_present}
...
\DoxyCodeLine{GLFWwindow* window = glfwCreateWindow(640, 480, \textcolor{stringliteral}{"{}Window Title"{}}, NULL, NULL);}
