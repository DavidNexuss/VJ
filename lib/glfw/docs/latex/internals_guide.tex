There are several interfaces inside GLFW. Each interface has its own area of responsibility and its own naming conventions.\hypertarget{internals_guide_internals_public}{}\doxysection{Public interface}\label{internals_guide_internals_public}
...
Examples\+: {\ttfamily glfw\+Create\+Window}, {\ttfamily GLFWwindow}, {\ttfamily GLFW\+\_\+\+RED\+\_\+\+BITS}\hypertarget{internals_guide_internals_native}{}\doxysection{Native interface}\label{internals_guide_internals_native}
...
Examples\+: {\ttfamily glfw\+Get\+X11\+Window}, {\ttfamily glfw\+Get\+WGLContext}\hypertarget{internals_guide_internals_internal}{}\doxysection{Internal interface}\label{internals_guide_internals_internal}
...
The internal interface is in charge of GLFW\textquotesingle{}s global data, which it stores in a {\ttfamily \+\_\+\+GLFWlibrary} struct named {\ttfamily \+\_\+glfw}.

The internal interface uses the same style as the public interface, except all global names have a leading underscore.

Examples\+: {\ttfamily \+\_\+glfw\+Is\+Valid\+Context\+Config}, {\ttfamily \+\_\+\+GLFWwindow}, {\ttfamily \+\_\+glfw.\+monitor\+Count}\hypertarget{internals_guide_internals_platform}{}\doxysection{Platform interface}\label{internals_guide_internals_platform}
...
Examples\+: {\ttfamily \+\_\+\+GLFWwindow\+X11}, {\ttfamily \+\_\+\+GLFWcontext\+WGL}
...
Examples\+: {\ttfamily window-\/\texorpdfstring{$>$}{>}win32.\+handle}, {\ttfamily \+\_\+glfw.\+x11.\+display}\hypertarget{internals_guide_internals_event}{}\doxysection{Event interface}\label{internals_guide_internals_event}
