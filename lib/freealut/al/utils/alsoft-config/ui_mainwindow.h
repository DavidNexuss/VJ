...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label_16->setGeometry(QRect(50, 60, 71, 31));
        label_16->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        hrtfStateComboBox = new QComboBox(tab_5);
        hrtfStateComboBox->addItem(QString());
        hrtfStateComboBox->addItem(QString());
        hrtfStateComboBox->addItem(QString());
        hrtfStateComboBox->setObjectName(QString::fromUtf8("hrtfStateComboBox"));
        hrtfStateComboBox->setGeometry(QRect(130, 60, 161, 31));
        hrtfStateComboBox->setSizeAdjustPolicy(QComboBox::AdjustToContentsOnFirstShow);
        ...
        wasapiResamplerCheckBox->setChecked(true);
...
#if QT_CONFIG(tooltip)
        channelConfigCombo->setToolTip(QCoreApplication::translate("MainWindow", "The output channel configuration. Note that not all backends\n"
"can properly detect the channel configuration and may default\n"
"to stereo output.", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        stereoEncodingComboBox->setToolTip(QCoreApplication::translate("MainWindow", "Pan Pot uses standard amplitude panning (aka\n"
...
"of 3D space with headphones.", nullptr));
#endif // QT_CONFIG(tooltip)
...
"listed above.", nullptr));
        ...
        label_16->setText(QCoreApplication::translate("MainWindow", "HRTF Mode:", nullptr));
        hrtfStateComboBox->setItemText(0, QCoreApplication::translate("MainWindow", "Application preference", nullptr));
        hrtfStateComboBox->setItemText(1, QCoreApplication::translate("MainWindow", "Force on", nullptr));
        hrtfStateComboBox->setItemText(2, QCoreApplication::translate("MainWindow", "Force off", nullptr));

#if QT_CONFIG(tooltip)
        hrtfStateComboBox->setToolTip(QCoreApplication::translate("MainWindow", "Forces HRTF processing on or off, or leaves it to the\n"
"application or system to determine if it should be used.", nullptr));
#endif // QT_CONFIG(tooltip)
